...
const Complete = () => {
    ...
    const handleEdit = e => {
        ...
        const image_url = form.imgUrl.value;

        const updateInfo = { name, number, description, image_url }

        //send form data to server
        fetch(`https://task-template-server.vercel.app/task/${task._id}`, {
            method: 'PUT',
            headers: {
    ...
    return (
            <div className="">
                <h1 className="text-2xl font-bold border border-orange-500">Complete</h1>
                {
                                    ...
                                    <div className="modal-box">
                                        ...
                                        <form className="card-body w-72" onSubmit={handleEdit}>
                                            ...
                                            <div className="form-control mt-6">
                                                <input className="bg-orange-500 rounded-lg p-3 text-white cursor-pointer" type="submit" value="Edit Task" />
                                            </div>
                                        </form>
